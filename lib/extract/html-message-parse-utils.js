(function(root, factory) {
    if (typeof define === 'function' && define.amd) {
        ...
        define(['exports', 'q', 'moment', 'underscore'], factory);
    } else if (typeof exports === 'object' && typeof exports.nodeName !== 'string') {
        // CommonJS
        factory(exports, require('q', 'moment', 'underscore'));
    } else {
        // Browser globals
        factory((root.commonJsStrict = {}), root.b);
    }
}(this, function(exports, q, moment, _, momentParseFormat) {
    ...
    /**
     * Parses messages.htm into javascript format in a worker thread.
     * @returns the array of messages and metadata extracted.
     */
    exports.parseWorker = function(messagesRaw, lang, progress) {

        var parsingMetaData = defaultParsingMetaData();
        parsingMetaData.lang = lang.key;
        parsingMetaData.dateFormat = lang.dateFormat;
        parsingMetaData.userName = exports.getNameFromRawMessages(messagesRaw);
    ...
    exports.parseLocaleFormattedDate = function(dateString, parsingMetaData) {
        ...
        if (!parsingMetaData.dateFormat) {
            ...
            /* Let the user define custom format if it does not have the language! */
            /* It can be set on the front page of the UI. */
            if (!parsingMetaData.dateFormat) {
        ...
        try {
            ...
            throw new Error('Error formatting date: "' + dateString + '" with date key: "' + parsingMetaData.dateFormat + '". Try setting a different format!');
        }
