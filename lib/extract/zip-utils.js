(function(root, factory) {
    ...
    /**
     * Extracts the html/messages.htm of the provided zip file
     * and resolves the promise with the string data.
     * @returns promise
     */
     ...
     * i.e.: en_US
     * NOTE: Facebook just stopped exporting this file making it harder to parse it.
     */
